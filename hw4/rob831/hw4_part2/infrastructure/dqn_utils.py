...
from rob831.hw4_part2.infrastructure.atari_wrappers import wrap_deepmind
...
def register_custom_envs():
    ...
    if 'LunarLander-v3' not in registry.env_specs:
        register(
            id='LunarLander-v3',
            entry_point='rob831.hw4_part2.envs.box2d.lunar_lander:LunarLander',
    ...
    if 'PointmassEasy-v0' not in registry.env_specs:
        register(
            id='PointmassEasy-v0',
            entry_point='rob831.hw4_part2.envs.pointmass.pointmass:Pointmass',
            kwargs={'difficulty': 0}
        )
